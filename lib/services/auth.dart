...
class AuthMethods {
  ...
  Future<User?> signInWithGoogle(BuildContext context) async {
    ...
    loginSocilaite(userDetails.displayName, userDetails.email, deviceToken,
            userDetails.uid, '', userDetails.photoURL)
        .then((value) {
      if (value.id > -1) {
        DatabaseMethods()
            .addUserInfoToDB(
  ...
  Future<User?> signUPWithEmailPassword(
      BuildContext context, email, password, username, isCompany) async {
    final FirebaseAuth _firebaseAuth = FirebaseAuth.instance;
